...
$id_entrenador = $_GET['id_entrenador'] ?? null;

// Validar que exista el ID
if (empty($id_entrenador) || !is_numeric($id_entrenador) || $id_entrenador <= 0) {
    header("Location: gestion_entrenadores.php"); // si no lo mandamos al listado de entrenadores
    exit();
}
...
");
$sqlMes->bindParam(':id_entrenador', $id_entrenador, PDO::PARAM_INT);
$sqlMes->execute();
...
");
$sqlProm->bindParam(':id_entrenador', $id_entrenador, PDO::PARAM_INT);
$sqlProm->execute();
...
<div class="attendance-container">
    ...
    <div class="stats-cards">
        ...
        <div class="stat-card">
            ...
            <div class="stat-label">Promedio del Entrenador</div>
        </div>
    </div>
