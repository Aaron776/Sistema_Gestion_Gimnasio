...
<style>
    ...
    * {
    ...
    .metric-card.peso {
        border-top-color: var(--weight);
    }

    .metric-card.grasa {
        border-top-color: var(--fat);
    }

    .metric-card.musculo {
        border-top-color: var(--muscle);
    }
...
<div class="page-header">
    <h1>Registrar Progreso de Socio</h1>
</div>
...
<div class="form-container">
    ...
    <form id="progreso-form" method="POST" action="controladores/registro_progreso.php">
                ...
                <div class="form-select-wrapper">
                    <select class="form-control" id="socio_id" name="id_socio" required>
                        ...
                        <?php foreach ($socios as $item): ?>
                            <option value="<?= htmlspecialchars($item->id_usuario) ?>"><?= htmlspecialchars($item->nombre_usuario) ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <p class="label-info">Seleccione el socio para registrar su progreso</p>
            </div>
        </div>

        <h2 style="margin-top: 40px; margin-bottom: 20px;"><i class="fas fa-chart-line"></i> Nuevas Métricas</h2>

        <div class="form-row">
            <div class="form-group">
                <label for="fecha_registro">Fecha de Registro <span class="required">*</span></label>
                <input type="date" class="form-control" id="fecha_registro" name="fecha_registro" required>
                <p class="label-info">Fecha en la que se toma la medición</p>
            </div>
        ...
        <div class="form-row">
            <div class="form-group">
                <label for="grasa_corporal">Grasa Corporal <span class="required">*</span></label>
                <div class="input-with-unit">
                    <input type="number" class="form-control" id="grasa_corporal" name="grasa_corporal" step="0.1" min="5" max="50" placeholder="Ej: 18.5" required>
                    <span class="unit">%</span>
                </div>
                <p class="label-info">Porcentaje de grasa corporal</p>
            </div>
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn btn-success">
                <i class="fas fa-save"></i> Registrar Progreso
            </button>
        </div>
    </form>
</div>
